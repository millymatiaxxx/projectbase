...
console.log(x) ("Seu décimo é" + variavel)*/
...
if (idade <12){
    alert ("Recomendável conteúdo infatil")
}
else if (idade <=12 && idade <=17){
    alert("Recomendável conteúdo teen")
}
else if (idade >=18 && idade <=60){
    alert("Recomendável conteúdo adulto")
}
else{
...
if (pontuacao = 1000){
    ...
    alert("Sua pontuação mais o bonus é"+ (pontuacao + 500),"seu nível é aprendiz")
}
else if (pontuacao >= 5001 && pontuacao <=10000){
    alert("Sua pontuação mais o bonus é"+ (pontuacao + 1000),"seu nível é expert")
}
else{
